...
// linearBar
var myCharts_linearBar = echarts.init(document.getElementById("linearBar"))
var colorArray = [
    {
        top: '#ffa800', //黄
...
option_linearBar = {
   ...
   grid: {
    ...
    series: [{
            ...
            barGap: '0%',
            barCategoryGap: '50%',
            data: [50, 100, 30, 200, 100]
        }

    ]
};
myCharts_linearBar.setOption(option_linearBar)